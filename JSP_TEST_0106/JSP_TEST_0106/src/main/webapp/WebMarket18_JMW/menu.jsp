...
<nav class="navbar navbar-expand  navbar-dark bg-dark">
	<div class="container">
		<div class="navbar-header">
			<a class="navbar-brand" href="/JSP_TEST_0106/WebMarket18_JMW/welcome.jsp">Home</a>
			...
			<ul class="navbar-nav mr-auto">
				<c:choose>
					<c:when test="${empty sessionId}">
						<li class="nav-item"><a class="nav-link" href="<c:url value="C:/JSP_TEST_0106/JSP_TEST_0106/src/main/webapp/member/loginMember.jsp"/>">로그인 </a></li>
						<li class="nav-item"><a class="nav-link" href='<c:url value="C:/JSP_TEST_0106/JSP_TEST_0106/src/main/webapp/member/addMember.jsp"/>'>회원 가입</a></li>
					</c:when>
					<c:otherwise>
